...
static NSString * const kConsumerKey       = @"jS7-73HufeD2cyTcRr_D4w";
static NSString * const kConsumerSecret    = @"tvjy4x6oqO6ydgUMINFudKG4JOw";
static NSString * const kToken             = @"32DuGXeQlMB14uhvwLW728EF0jFVn30W";
static NSString * const kTokenSecret       = @"hzbZz-l0zyEnRw3GfZ2HfCTVZdU";
